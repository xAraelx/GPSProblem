...
"""LO que hay que modificar hay que añadir dos contadores para nodos generados y nodo visitados """
def graph_search(problem, listaAbierta):
...
def branch_bound_graph_search(problem):
    """Search the shallowest nodes in the search tree first. [p 74]"""
    return graph_search(problem, priority_list())  # FIFOQueue -> fringe
